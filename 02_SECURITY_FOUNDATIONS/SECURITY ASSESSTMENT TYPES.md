...
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| **Network/Infrastructure Pentest** | Assess all aspects of a computer network (internal or external network infrastructure).<br>These types of penetration testers typically must have a strong understanding of networking, Windows, Linux, Active Directory, and at least one scripting language.                                                | Routers, firewalls, workstations      |
...
| **Social Engineering Pentest**     | Social engineering pentesters test human beings.<br><br>- Can employees be fooled by phishing, vishing (phishing over the phone), or other scams?<br>- Can a social engineering pentester walk up to a receptionist and say, "yes, I work here?"                                                              | Employees, helpdesks, phishing emails |
...
| Type               | Stealth Level | Detectable by Security Tools? | Typical Use Case                         | Description |
| ------------------ | ------------- | ----------------------------- | ---------------------------------------- | ----------- |
