...
- **CorpDocs**:  This was a Broken Access Control exploit challenge.Here I discovered an `/admin` endpoint via a gobsuter brute force. Accessed it directly via my browser and there was the flag. 
