...
- [[#✅ AI Solutions Portal Profile Peek (100 pts)|✅ AI Solutions Portal Profile Peek (100 pts)]]
	- [[#✅ AI Solutions Portal Profile Peek (100 pts)#Task|Task]]
	- [[#✅ AI Solutions Portal Profile Peek (100 pts)#Category: Web|Category: Web]]
	- [[#✅ AI Solutions Portal Profile Peek (100 pts)#Tools Used|Tools Used]]
	- [[#✅ AI Solutions Portal Profile Peek (100 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ AI Solutions Portal Profile Peek (100 pts)#🚩 Flag Captured: `h4kit{broken_object_control_found_4bb42c8346d9}`|🚩 Flag Captured: `h4kit{broken_object_control_found_4bb42c8346d9}`]]
	- [[#✅ AI Solutions Portal Profile Peek (100 pts)#Lessons Learned|Lessons Learned]]
- [[#✅ CorpDocs (200 pts)|✅ CorpDocs (200 pts)]]
	- [[#✅ CorpDocs (200 pts)#Task|Task]]
	- [[#✅ CorpDocs (200 pts)#Category: Web|Category: Web]]
	- [[#✅ CorpDocs (200 pts)#Tools Used|Tools Used]]
	- [[#✅ CorpDocs (200 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ CorpDocs (200 pts)#🚩 Flag Captured: `h4kit{admin_panel_not_restricted_0825a0215d83}`|🚩 Flag Captured: `h4kit{admin_panel_not_restricted_0825a0215d83}`]]
	- [[#✅ CorpDocs (200 pts)#Lessons Learned|Lessons Learned]]
- [[#✅ DevPortal Ownership Override (200 pts)|✅ DevPortal Ownership Override (200 pts)]]
	- [[#✅ DevPortal Ownership Override (200 pts)#Task|Task]]
	- [[#✅ DevPortal Ownership Override (200 pts)#Category: Web|Category: Web]]
	- [[#✅ DevPortal Ownership Override (200 pts)#Tools Used|Tools Used]]
	- [[#✅ DevPortal Ownership Override (200 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ DevPortal Ownership Override (200 pts)#🚩 Flag Captured: `h4kit{email_override_success_e2359b737f00}`|🚩 Flag Captured: `h4kit{email_override_success_e2359b737f00}`]]
	- [[#✅ DevPortal Ownership Override (200 pts)#Lessons Learned|Lessons Learned]]
- [[#✅ PDFVault Internal Peeker (200 pts)|✅ PDFVault Internal Peeker (200 pts)]]
	- [[#✅ PDFVault Internal Peeker (200 pts)#Task|Task]]
	- [[#✅ PDFVault Internal Peeker (200 pts)#Category: Web|Category: Web]]
	- [[#✅ PDFVault Internal Peeker (200 pts)#Tools Used|Tools Used]]
	- [[#✅ PDFVault Internal Peeker (200 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ PDFVault Internal Peeker (200 pts)#🚩Flag Captured: `h4kit{ssrf_approved_metadata_149a4b9a7a89}`|🚩Flag Captured: `h4kit{ssrf_approved_metadata_149a4b9a7a89}`]]
- [[#✅ ResetRealm Predictable Recovery (100 pts)|✅ ResetRealm Predictable Recovery (100 pts)]]
	- [[#✅ ResetRealm Predictable Recovery (100 pts)#Task|Task]]
	- [[#✅ ResetRealm Predictable Recovery (100 pts)#Category: Web|Category: Web]]
	- [[#✅ ResetRealm Predictable Recovery (100 pts)#Tools Used|Tools Used]]
	- [[#✅ ResetRealm Predictable Recovery (100 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ ResetRealm Predictable Recovery (100 pts)#🚩Flag Captured: `h4kit{token_predictable_reset_211726c8129d}`|🚩Flag Captured: `h4kit{token_predictable_reset_211726c8129d}`]]
	- [[#✅ ResetRealm Predictable Recovery (100 pts)#Lessons Learned|Lessons Learned]]
- [[#✅ ScriptServe Unsigned Update (200 pts)|✅ ScriptServe Unsigned Update (200 pts)]]
	- [[#✅ ScriptServe Unsigned Update (200 pts)#Task|Task]]
	- [[#✅ ScriptServe Unsigned Update (200 pts)#Category: Web|Category: Web]]
	- [[#✅ ScriptServe Unsigned Update (200 pts)#Tools Used|Tools Used]]
	- [[#✅ ScriptServe Unsigned Update (200 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ ScriptServe Unsigned Update (200 pts)#🚩Flag Captured: `h4kit{insecure_pipeline_exec_4212f73ceac2}`|🚩Flag Captured: `h4kit{insecure_pipeline_exec_4212f73ceac2}`]]
	- [[#✅ ScriptServe Unsigned Update (200 pts)#Lessons Learned|Lessons Learned]]
- [[#✅Browser Trail (200 pts)|✅Browser Trail (200 pts)]]
	- [[#✅Browser Trail (200 pts)#Task|Task]]
	- [[#✅Browser Trail (200 pts)#Category: Forensics|Category: Forensics]]
	- [[#✅Browser Trail (200 pts)#Tools Used|Tools Used]]
	- [[#✅Browser Trail (200 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅Browser Trail (200 pts)#🚩Flag Captured: `h4kit{browser_phish_flag}`|🚩Flag Captured: `h4kit{browser_phish_flag}`]]
	- [[#✅Browser Trail (200 pts)#Lessons Learned|Lessons Learned]]
- [[#✅ Memory Leak (100 pts)|✅ Memory Leak (100 pts)]]
	- [[#✅ Memory Leak (100 pts)#Task|Task]]
	- [[#✅ Memory Leak (100 pts)#Category: Forensics|Category: Forensics]]
	- [[#✅ Memory Leak (100 pts)#Tools Used|Tools Used]]
	- [[#✅ Memory Leak (100 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ Memory Leak (100 pts)#🚩Flag Captured: `h4kit{memdump_easy_flag}`|🚩Flag Captured: `h4kit{memdump_easy_flag}`]]
- [[#✅ PhishCheck (100 pts)|✅ PhishCheck (100 pts)]]
	- [[#✅ PhishCheck (100 pts)#Task|Task]]
	- [[#✅ PhishCheck (100 pts)#Category: Forensics|Category: Forensics]]
	- [[#✅ PhishCheck (100 pts)#Tools Used|Tools Used]]
	- [[#✅ PhishCheck (100 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ PhishCheck (100 pts)#🚩Flag Captured:  `h4kit{phish_flag_easy}`|🚩Flag Captured:  `h4kit{phish_flag_easy}`]]
	- [[#✅ PhishCheck (100 pts)#Lessons Learned|Lessons Learned]]
- [[#✅ SSH Credential Breach (200 pts)|✅ SSH Credential Breach (200 pts)]]
	- [[#✅ SSH Credential Breach (200 pts)#Task|Task]]
	- [[#✅ SSH Credential Breach (200 pts)#Category: Forensics|Category: Forensics]]
	- [[#✅ SSH Credential Breach (200 pts)#Tools Used|Tools Used]]
	- [[#✅ SSH Credential Breach (200 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ SSH Credential Breach (200 pts)#🚩Flag Captured: `h4kit{ssh_breach_flag_45}`|🚩Flag Captured: `h4kit{ssh_breach_flag_45}`]]
	- [[#✅ SSH Credential Breach (200 pts)#Analysis|Analysis]]
	- [[#✅ SSH Credential Breach (200 pts)#Lessons Learned|Lessons Learned]]
- [[#✅ Greek Gods (100 pts)|✅ Greek Gods (100 pts)]]
	- [[#✅ Greek Gods (100 pts)#Task|Task]]
	- [[#✅ Greek Gods (100 pts)#Category: PPC|Category: PPC]]
	- [[#✅ Greek Gods (100 pts)#Code Audit|Code Audit]]
		- [[#Code Audit#What Does This Code Do?|What Does This Code Do?]]
		- [[#Code Audit#What Is the Flaw?|What Is the Flaw?]]
	- [[#✅ Greek Gods (100 pts)#Tools Used|Tools Used]]
	- [[#✅ Greek Gods (100 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ Greek Gods (100 pts)#🚩Flag Captured: `h4kit{@app.route("/admin")}`|🚩Flag Captured: `h4kit{@app.route("/admin")}`]]
	- [[#✅ Greek Gods (100 pts)#Lessons Learned|Lessons Learned]]
- [[#✅ Greek Gods 2 (50 pts)|✅ Greek Gods 2 (50 pts)]]
	- [[#✅ Greek Gods 2 (50 pts)#Task|Task]]
	- [[#✅ Greek Gods 2 (50 pts)#Category: PPC|Category: PPC]]
	- [[#✅ Greek Gods 2 (50 pts)#🚩Flag Captured: `h4kit{business logic flaw}`|🚩Flag Captured: `h4kit{business logic flaw}`]]
- [[#✅ Misunderstood (200 pts)|✅ Misunderstood (200 pts)]]
	- [[#✅ Misunderstood (200 pts)#Task|Task]]
	- [[#✅ Misunderstood (200 pts)#Category: PPC|Category: PPC]]
	- [[#✅ Misunderstood (200 pts)#Code Audit|Code Audit]]
		- [[#Code Audit#What Does This Code Do?|What Does This Code Do?]]
		- [[#Code Audit#What Is the Flaw?|What Is the Flaw?]]
	- [[#✅ Misunderstood (200 pts)#Tools Used|Tools Used]]
	- [[#✅ Misunderstood (200 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ Misunderstood (200 pts)#🚩Flag Captured: `h4kit{tokens[get_ip()]}`|🚩Flag Captured: `h4kit{tokens[get_ip()]}`]]
- [[#✅ Misunderstood 2 (50 pts)|✅ Misunderstood 2 (50 pts)]]
	- [[#✅ Misunderstood 2 (50 pts)#Task|Task]]
	- [[#✅ Misunderstood 2 (50 pts)#Category: PPC|Category: PPC]]
	- [[#✅ Misunderstood 2 (50 pts)#🚩Flag Captured: `h4kit{business logic flaw}`|🚩Flag Captured: `h4kit{business logic flaw}`]]
- [[#✅ Pennies (300 pts)|✅ Pennies (300 pts)]]
	- [[#✅ Pennies (300 pts)#Task|Task]]
	- [[#✅ Pennies (300 pts)#Category: PPC|Category: PPC]]
	- [[#✅ Pennies (300 pts)#Code Audit|Code Audit]]
		- [[#Code Audit#What Does This Code Do?|What Does This Code Do?]]
		- [[#Code Audit#What Is the Flaw?|What Is the Flaw?]]
	- [[#✅ Pennies (300 pts)#Tools Used|Tools Used]]
	- [[#✅ Pennies (300 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ Pennies (300 pts)#🚩Flag Captured: `h4kit{order.request_refund()}`|🚩Flag Captured: `h4kit{order.request_refund()}`]]
- [[#✅ Pennies 2 (50 pts)|✅ Pennies 2 (50 pts)]]
	- [[#✅ Pennies 2 (50 pts)#Task|Task]]
	- [[#✅ Pennies 2 (50 pts)#Category: PPC|Category: PPC]]
	- [[#✅ Pennies 2 (50 pts)#🚩Flag Captured: `h4kit{business logic flaw}`|🚩Flag Captured: `h4kit{business logic flaw}`]]
- [[#✅ The Royalties (200 pts)|✅ The Royalties (200 pts)]]
	- [[#✅ The Royalties (200 pts)#Task|Task]]
	- [[#✅ The Royalties (200 pts)#Category: PPC|Category: PPC]]
	- [[#✅ The Royalties (200 pts)#Code Audit|Code Audit]]
		- [[#Code Audit#What Does This Code Do?|What Does This Code Do?]]
		- [[#Code Audit#What Is the Flaw?|What Is the Flaw?]]
	- [[#✅ The Royalties (200 pts)#Tools Used|Tools Used]]
	- [[#✅ The Royalties (200 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ The Royalties (200 pts)#🚩Flag Captured: `h4kit{self.points}`|🚩Flag Captured: `h4kit{self.points}`]]
- [[#✅ The Royalties 2 (50 pts)|✅ The Royalties 2 (50 pts)]]
	- [[#✅ The Royalties 2 (50 pts)#Task|Task]]
	- [[#✅ The Royalties 2 (50 pts)#Category: PPC|Category: PPC]]
	- [[#✅ The Royalties 2 (50 pts)#🚩Flag Captured: `h4kit{business logic flaw}`|🚩Flag Captured: `h4kit{business logic flaw}`]]
- [[#✅ The puppetior (100 pts)|✅ The puppetior (100 pts)]]
	- [[#✅ The puppetior (100 pts)#Task|Task]]
	- [[#✅ The puppetior (100 pts)#Category: PPC|Category: PPC]]
	- [[#✅ The puppetior (100 pts)#Code Audit|Code Audit]]
	- [[#✅ The puppetior (100 pts)#What Does This Code Do?|What Does This Code Do?]]
	- [[#✅ The puppetior (100 pts)#What Is the Flaw?|What Is the Flaw?]]
	- [[#✅ The puppetior (100 pts)#Tools Used|Tools Used]]
	- [[#✅ The puppetior (100 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ The puppetior (100 pts)#🚩Flag Captured: `h4kit{self.discount_applied, apply_discount}`|🚩Flag Captured: `h4kit{self.discount_applied, apply_discount}`]]
- [[#✅ The puppetior 2 (50 pts)|✅ The puppetior 2 (50 pts)]]
	- [[#✅ The puppetior 2 (50 pts)#Task|Task]]
	- [[#✅ The puppetior 2 (50 pts)#Category: PPC|Category: PPC]]
	- [[#✅ The puppetior 2 (50 pts)#🚩Flag Captured: `h4kit{business logic flaw}`|🚩Flag Captured: `h4kit{business logic flaw}`]]
- [[#✅ Transfer Us (200 pts)|✅ Transfer Us (200 pts)]]
	- [[#✅ Transfer Us (200 pts)#Task|Task]]
	- [[#✅ Transfer Us (200 pts)#Category: PPC|Category: PPC]]
	- [[#✅ Transfer Us (200 pts)#Code Audit|Code Audit]]
	- [[#✅ Transfer Us (200 pts)#What Does This Code Do?|What Does This Code Do?]]
	- [[#✅ Transfer Us (200 pts)#What Is the Flaw?|What Is the Flaw?]]
	- [[#✅ Transfer Us (200 pts)#Tools Used|Tools Used]]
	- [[#✅ Transfer Us (200 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ Transfer Us (200 pts)#✅ Exploit Result:|✅ Exploit Result:]]
	- [[#✅ Transfer Us (200 pts)#🚩Flag Captured: `h4kit{sender.withdraw(amount), receiver.deposit(amount)}`|🚩Flag Captured: `h4kit{sender.withdraw(amount), receiver.deposit(amount)}`]]
- [[#✅ Transfer Us 2 (50 pts)|✅ Transfer Us 2 (50 pts)]]
	- [[#✅ Transfer Us 2 (50 pts)#Task|Task]]
	- [[#✅ Transfer Us 2 (50 pts)#Category: PPC|Category: PPC]]
	- [[#✅ Transfer Us 2 (50 pts)#🚩Flag Captured: `h4kit{business logic flaw}`|🚩Flag Captured: `h4kit{business logic flaw}`]]
- [[#✅ Root of All Trouble (100 pts)|✅ Root of All Trouble (100 pts)]]
	- [[#✅ Root of All Trouble (100 pts)#Task|Task]]
	- [[#✅ Root of All Trouble (100 pts)#Category: Pentest|Category: Pentest]]
	- [[#✅ Root of All Trouble (100 pts)#Tools Used|Tools Used]]
	- [[#✅ Root of All Trouble (100 pts)#Exploitation Steps|Exploitation Steps]]
	- [[#✅ Root of All Trouble (100 pts)#🚩Flag Captured: `h4kit{root_login_still_alive_98afb5c58968}`|🚩Flag Captured: `h4kit{root_login_still_alive_98afb5c58968}`]]
